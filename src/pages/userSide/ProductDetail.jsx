...
import { ShoppingCart, ArrowLeft, Star, Shield, Truck, Package, ChevronLeft, ChevronRight, Minus, Plus, Zap, Award, RotateCcw } from 'lucide-react'
...
export default function ProductDetail() {
    ...
    const related = products.filter(p => normalizeCategory(p.category) === normalizeCategory(category) && p._id !== id).slice(0, 4)
