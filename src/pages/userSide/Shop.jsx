...
import {
    ...
    Package, LayoutGrid, ArrowRight, Tag
} from 'lucide-react'
...
export default function Shop() {
    ...
    const filtered = useMemo(() => {
        let r = [...products]
        if (qCategory !== 'All') r = r.filter(p => p.category === qCategory)
        if (qSearch) r = r.filter(p =>
            p.name?.toLowerCase().includes(qSearch.toLowerCase()) ||
            p.description?.toLowerCase().includes(qSearch.toLowerCase()))
  ...
  gap-4 mb-6 pb-5 border-b border-white/[0.05]"
                        >
                            <span
                                className="font-['Orbitron',monospace] text-[9px] tracking-[0.18em]
    uppercase text-white/20 text-center md:text-left"
                            ...
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
                                ...
                                <form
                                    ...
                                    className="w-full sm:flex-1 md:min-w-[300px]"
                                >
