...
// // ── localStorage helpers (inline, no utils file needed) ──────────────────────
...
//     // ── Wishlist state — initialised from localStorage ────────────────────────
...
//             })
//         } else {
//             // Add — shape must match what Wishlist.jsx expects
//             const item = {
//                 id,
//                 name: displayName,
//                 brand: brand || '',
...
//                         aria-label={wished ? 'Remove from wishlist' : 'Add to wishlist'}
//                         className="absolute top-3 right-3 w-8 h-8 rounded-lg flex items-center justify-center bg-[rgba(8,2,2,0.7)] border backdrop-blur-sm transition-all duration-200 opacity-0 group-hover:opacity-100"
//                         style={{
//                             borderColor: wished ? 'rgba(220,38,38,0.5)' : 'rgba(255,255,255,0.1)',
//                         }}
//                     >
//                         <Heart
//                             size={14}
...
function saveWishlist(items) {
    try {
        ...
        // Notify same-tab listeners (e.g. Navbar) immediately
